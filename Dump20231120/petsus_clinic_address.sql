...
--
-- Dumping data for table `clinic_address`
--

LOCK TABLES `clinic_address` WRITE;
/*!40000 ALTER TABLE `clinic_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `clinic_address` ENABLE KEYS */;
UNLOCK TABLES;
