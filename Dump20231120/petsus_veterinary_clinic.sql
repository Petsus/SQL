...
CREATE TABLE `veterinary_clinic` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_veterinary_clinic_veterinary_id` (`veterinary_id`),
  KEY `fk_veterinary_clinic_clinic_id` (`clinic_id`),
...
INSERT INTO `veterinary_clinic` VALUES (1,'2023-11-12 20:50:13','2023-11-12 20:50:13',1,1);
